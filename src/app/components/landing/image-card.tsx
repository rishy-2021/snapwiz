...
const ImageCard = () => {
  ...
  return (
    <div className="relative">
      <div className="w-100vw flex justify-evenly flex-row h-500 px-5">
        {state.map((val, idx) => (
      ...
      <Button
        ...
        className="absolute inset-y-1/2 left-10 bg-green-200 -mt-4"
        size="large"
        onClick={onMoveBackward}
      />
      <Button
        icon={<FaChevronCircleRight size={25} />}
        className="absolute inset-y-1/2 right-10 -mt-4 bg-green-200"
        size="large"
